...
def args_parser():
    ...
    parser.add_argument("--resume", type=str, default="logs/checkpoint_25.pth")
...
def main(args):
    ...
    if len(dataset) == 0:
        raise ValueError(f"Dataset is empty, path: {args.dataset_path}")
    ...
    print(f"Total Batch Size: {args.batch_size * args.grad_steps}")
    print(f"\nUsing Arguments")
    print(args)
